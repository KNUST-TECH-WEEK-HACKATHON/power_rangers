        ...
        <div className='min-h-screen bg-[#222]'>
            ...
            {(data && data.length > 0) &&
                <div className="grid-box px-24 py-12 gap-6">
                    { data.map((item, index) => 
                        <div onClick={() => navigate('/api/' + item.id)} className="item h-[200px] rounded shadow bg-[#333] hover:bg-blue-500 hover:bg-opacity-10 cursor-pointer flex flex-col justify-center items-center p-1.5 relative">
                            <span>
